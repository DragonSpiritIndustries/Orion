...
ScriptEngine::ScriptEngine()
{
    ...
    else
    {
        ...
        // Vector2
        m_engineHandle->RegisterObjectType("Vector2f", sizeof(Vector2f), asOBJ_VALUE | asOBJ_APP_CLASS_CDAK);
        m_engineHandle->RegisterObjectBehaviour("Vector2f", asBEHAVE_CONSTRUCT, "void f()", asFUNCTION(constructVector2f), asCALL_CDECL_OBJLAST);
        m_engineHandle->RegisterObjectBehaviour("Vector2f", asBEHAVE_CONSTRUCT, "void f(float, float)", asFUNCTION(constructVector2fArgs), asCALL_CDECL_OBJLAST);
        m_engineHandle->RegisterObjectBehaviour("Vector2f", asBEHAVE_DESTRUCT,  "void f()", asFUNCTION(destructVector2f), asCALL_CDECL_OBJLAST);
        m_engineHandle->RegisterObjectMethod("Vector2f", "Vector2f &opAssign(const Vector2f &in)", asMETHODPR(Vector2f, operator =, (const Vector2f&), Vector2f&), asCALL_THISCALL);
        ...
        m_engineHandle->RegisterObjectType("Vector2d", sizeof(Vector2d), asOBJ_VALUE | asOBJ_APP_CLASS_CDAK);
        m_engineHandle->RegisterObjectBehaviour("Vector2d", asBEHAVE_CONSTRUCT, "void f()", asFUNCTION(constructVector2d), asCALL_CDECL_OBJLAST);
        m_engineHandle->RegisterObjectBehaviour("Vector2d", asBEHAVE_CONSTRUCT, "void f(double, double)", asFUNCTION(constructVector2dArgs), asCALL_CDECL_OBJLAST);
        m_engineHandle->RegisterObjectBehaviour("Vector2d", asBEHAVE_DESTRUCT,  "void f()", asFUNCTION(destructVector2d), asCALL_CDECL_OBJLAST);
        m_engineHandle->RegisterObjectMethod("Vector2d", "Vector2d &opAssign(const Vector2d &in)", asMETHODPR(Vector2d, operator =, (const Vector2d&), Vector2d&), asCALL_THISCALL);
        m_engineHandle->RegisterObjectProperty("Vector2d", "double x", asOFFSET(Vector2d, x));
        m_engineHandle->RegisterObjectProperty("Vector2d", "double y", asOFFSET(Vector2d, y));
        m_engineHandle->RegisterObjectType("Vector2i", sizeof(Vector2i), asOBJ_VALUE | asOBJ_APP_CLASS_CDAK);
        m_engineHandle->RegisterObjectBehaviour("Vector2i", asBEHAVE_CONSTRUCT, "void f()", asFUNCTION(constructVector2i), asCALL_CDECL_OBJLAST);
        m_engineHandle->RegisterObjectBehaviour("Vector2i", asBEHAVE_CONSTRUCT, "void f(int, int)", asFUNCTION(constructVector2iArgs), asCALL_CDECL_OBJLAST);
        m_engineHandle->RegisterObjectBehaviour("Vector2i", asBEHAVE_DESTRUCT,  "void f()", asFUNCTION(destructVector2i), asCALL_CDECL_OBJLAST);
        m_engineHandle->RegisterObjectMethod("Vector2i", "Vector2i &opAssign(const Vector2f &in)", asMETHODPR(Vector2i, operator =, (const Vector2i&), Vector2i&), asCALL_THISCALL);
        ...
        m_engineHandle->RegisterObjectBehaviour("Vector3f", asBEHAVE_DESTRUCT,  "void f()", asFUNCTION(destructVector2f), asCALL_CDECL_OBJLAST);
        ...
        m_engineHandle->RegisterObjectBehaviour("Vector3d", asBEHAVE_DESTRUCT,  "void f()", asFUNCTION(destructVector2f), asCALL_CDECL_OBJLAST);
        ...
        m_engineHandle->RegisterObjectBehaviour("Vector3i", asBEHAVE_CONSTRUCT, "void f()", asFUNCTION(constructVector3d), asCALL_CDECL_OBJLAST);
        m_engineHandle->RegisterObjectBehaviour("Vector3i", asBEHAVE_CONSTRUCT, "void f(int, int, int)", asFUNCTION(constructVector3dArgs), asCALL_CDECL_OBJLAST);
        m_engineHandle->RegisterObjectBehaviour("Vector3i", asBEHAVE_DESTRUCT,  "void f()", asFUNCTION(destructVector2f), asCALL_CDECL_OBJLAST);
